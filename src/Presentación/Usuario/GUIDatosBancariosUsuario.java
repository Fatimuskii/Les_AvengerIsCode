...
public class GUIDatosBancariosUsuario extends JFrame {
	...
	public void initGUI() {
		...
		txtNmeroDeTarjeta.addFocusListener(new FocusAdapter() {
			@Override
			public void focusGained(FocusEvent arg0) {
				if (txtNmeroDeTarjeta.getText().equals("Número de tarjeta")) {
			...
			public void focusLost(FocusEvent e) {
				if (txtNmeroDeTarjeta.getText().equals("")) {
		...
		txtNombreEnLa.addFocusListener(new FocusAdapter() {
			@Override
			public void focusGained(FocusEvent arg0) {
				if (txtNombreEnLa.getText().equals("Nombre en la tarjeta")) {
			...
			@Override
			public void focusLost(FocusEvent e) {
				if (txtNombreEnLa.getText().equals("")) {
			...
			public void mouseClicked(MouseEvent e) {
				if (txtNmeroDeTarjeta.getText().length() != 16) {
					JOptionPane.showMessageDialog(new JFrame(),
							"El numero de la tarjeta debe tener 16 dígitos");
				}
			}
		});
